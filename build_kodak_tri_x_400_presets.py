"""
Kodak Tri-X 400 preset generation script
...
SAMPLE_DIR  = Path(r"C:\Users\sakamoto\kodak_tri_x_400_samples")
PRESET_SNAP = "KodakTriX400_スナップ"
PRESET_LAND = "KodakTriX400_風景"
...
def main():
    ...
    save_preset(PRESET_SNAP, snap_params,
                {**snap_meta, "description": "Kodak Tri-X 400 / snap"})
    ...
    save_preset(PRESET_LAND, land_params,
                {**land_meta, "description": "Kodak Tri-X 400 / landscape"})
