"""
Kodak Portra 800 preset generation script
...
SAMPLE_DIR  = Path(r"C:\Users\sakamoto\kodak_portra_800_samples")
PRESET_SNAP = "KodakPortra800_スナップ"
PRESET_LAND = "KodakPortra800_風景"
...
def main():
    ...
    save_preset(PRESET_SNAP, snap_params,
                {**snap_meta, "description": "Kodak Portra 800 / snap"})
    ...
    save_preset(PRESET_LAND, land_params,
                {**land_meta, "description": "Kodak Portra 800 / landscape"})
