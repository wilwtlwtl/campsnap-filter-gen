"""
Agfa Vista 200 preset generation script
...
SAMPLE_DIR  = Path(r"C:\Users\sakamoto\agfa_vista_200_samples")
PRESET_SNAP = "AgfaVista200_スナップ"
PRESET_LAND = "AgfaVista200_風景"
...
def main():
    ...
    save_preset(PRESET_SNAP, snap_params,
                {**snap_meta, "description": "Agfa Vista 200 / snap"})
    ...
    save_preset(PRESET_LAND, land_params,
                {**land_meta, "description": "Agfa Vista 200 / landscape"})
