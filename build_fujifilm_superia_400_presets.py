"""
Fujifilm Superia 400 プリセット生成スクリプト
スナップ・風景のサンプル画像を解析し presets.json / default_presets.json に保存する。
"""
...
SAMPLE_DIR   = Path(r"C:\Users\sakamoto\fujifilm_superia_400_samples")
PRESET_SNAP  = "FujiSuperia400_スナップ"
PRESET_LAND  = "FujiSuperia400_風景"
...
def main():
    ...
    print(f"\n=== {PRESET_SNAP} ({len(snap_paths)}mai) ===")
    ...
    save_preset(PRESET_SNAP, snap_params, {**snap_meta, "description": "Fujifilm Superia 400 / snap"})
    print(f"  [OK] {PRESET_SNAP} saved")

    print(f"\n=== {PRESET_LAND} ({len(land_paths)}mai) ===")
    ...
    save_preset(PRESET_LAND, land_params, {**land_meta, "description": "Fujifilm Superia 400 / landscape"})
