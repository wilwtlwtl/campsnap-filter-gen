"""
Lomo Lady Grey 400 プリセット生成スクリプト（モノクロフィルム）
スナップ・風景のサンプル画像を解析し default_presets.json に保存する。
"""
...
SAMPLE_DIR   = Path(r"C:\Users\sakamoto\lomo_lady_grey_400_samples")
PRESET_SNAP  = "LomoLadyGrey400_スナップ"
PRESET_LAND  = "LomoLadyGrey400_風景"
...
def main():
    ...
    save_preset(PRESET_SNAP, snap_params,
                {**snap_meta, "description": "Lomo Lady Grey 400 (B&W) / snap"})
    ...
    save_preset(PRESET_LAND, land_params,
                {**land_meta, "description": "Lomo Lady Grey 400 (B&W) / landscape"})
