"""
Cinestill 800T preset generation script
...
SAMPLE_DIR  = Path(r"C:\Users\sakamoto\cinestill_800t_samples")
PRESET_SNAP = "Cinestill800T_スナップ"
PRESET_LAND = "Cinestill800T_風景"
...
def main():
    ...
    save_preset(PRESET_SNAP, snap_params,
                {**snap_meta, "description": "Cinestill 800T / snap"})
    ...
    save_preset(PRESET_LAND, land_params,
                {**land_meta, "description": "Cinestill 800T / landscape"})
