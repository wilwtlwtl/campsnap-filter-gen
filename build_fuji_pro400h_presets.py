...
SAMPLE_DIR   = Path(r"C:\Users\sakamoto\fuji_pro400h_samples")
PRESET_SNAP  = "FujiPro400H_スナップ"
PRESET_LAND  = "FujiPro400H_風景"
...
def main():
    ...
    save_preset(PRESET_SNAP, snap_params,
                {**snap_meta, "description": "Fuji Pro 400H / snap"})
    ...
    save_preset(PRESET_LAND, land_params,
                {**land_meta, "description": "Fuji Pro 400H / landscape"})
